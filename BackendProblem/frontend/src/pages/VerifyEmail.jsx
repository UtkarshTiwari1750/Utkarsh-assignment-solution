            ...
            (
                <div className=' w-[480px] mx-auto p-8'>
                    ...
                    >
                        <OTPInput 
                            ...
                            renderInput={
                                ...
                                className='w-full rounded-lg p-3 border border-black text-center mx-2'
                                    />
                            }
                        />

                        <button type='submit'
                        className='p-3 w-full text-center bg-yellow-300 rounded-lg text-[16px] font-bold font-inter text-richblack-900 mt-6'
                        >
                            Verify Email
                        </button>
                    </form>
                    ...
                    <div className='flex w-full justify-between p-4 mt-4'>
                        ...
                        <button 
                        className='flex items-center gap-1 text-[#161CBB]'
